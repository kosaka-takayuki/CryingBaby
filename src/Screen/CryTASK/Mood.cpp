...
//Serial.print("#D");
	...
	/////////////////////////////////////////////////////////////////////////////////////
  	RunNo  = GetNo_TASK_Mood(TASK_Name_Mood);	//指定されたTASKのNo


	DrawTitle("Mood", 600, Device.TASK[RunNo].Status );
	...
	if( Device.isModeChangeFirstTime == false ){
		...
		if(Device.isHelp == true){
			Device.AquesTalk.playK("機嫌", 50, Device.isAquesTalk);                          //AquesTalkで会話　会話スピードは最低の50
		}
		Device.InfoData[ 0].Name = "State";
		Device.InfoData[ 1].Name = "Remaining";
		Device.InfoData[ 2].Name = "Mood";

		Device.InfoData[ 3].Name = "Microphone";		Device.InfoData[ 3].isActice = Device.Sensor.Microphone.isRun;
		Device.InfoData[ 4].Name = "Eye Sensor";		Device.InfoData[ 4].isActice = Device.Sensor.Eye.isRun;
		Device.InfoData[ 5].Name = "Milk Temperature";	Device.InfoData[ 5].isActice = Device.Sensor.Temperature.isRun;
		Device.InfoData[ 6].Name = "Ton Per Minutes";	Device.InfoData[ 6].isActice = Device.Sensor.TPM.isRun;
		Device.InfoData[ 7].Name = "IMU";				Device.InfoData[ 7].isActice = Device.Sensor.IMU.isRun;
		Device.InfoData[ 8].Name = "Position";			Device.InfoData[ 8].isActice = Device.Sensor.Position.isRun;
		...
		switch (Device.TASK[RunNo].Status){
			case TASK_Status_Non:			Device.Button[ Button_TASK_Mood	].SetSelectButton(0);	Device.Button[ Button_TASK_Mood ].SelectButton_OLD =0;		isRun = false;	break;
			case TASK_Status_Count:			Device.Button[ Button_TASK_Mood	].SetSelectButton(1); 	Device.Button[ Button_TASK_Mood ].SelectButton_OLD =1;		isRun = false;	break;
			case TASK_Status_Wait:			Device.Button[ Button_TASK_Mood	].SetSelectButton(2);	Device.Button[ Button_TASK_Mood ].SelectButton_OLD =2;		isRun = false;	break;
			case TASK_Status_Run:			Device.Button[ Button_TASK_Mood	].SetSelectButton(3);	Device.Button[ Button_TASK_Mood ].SelectButton_OLD =3;		isRun = true;	break;
		}


		Device.Button[Button_TASK_Mood	    ].isClick = false;
		Device.Button[Button_TASK_Mood	    ].ClickPoint_B.x =-1;
		Device.Button[Button_TASK_Mood	    ].ClickPoint_B.y =-1;
	...
	//フリックボタンの描写
	////////////////////////////////////////////////
	if( Device.Button[ Button_TASK_Mood ].DrawButton( Button_TASK_Mood, 190 )  == true){	isDraw =true;	DrawMSG +="Button \t";}
