...
//AquesTalkTTS  *AquesTalk;    // the only instance of AquesTalkTTS class
...
void AquesTalkTTS::release()
{
  ...
  workbuf = 0; workbufK = 0; taskAquesTalk = 0; muxAquesTalk = 0;
}
...
//Speed 50-100
int AquesTalkTTS::playK(const char *kanji, int speed, boolean isTalk){
  if(isTalk ==true){
	int iret;
...
void AquesTalkTTS::SetVolume(int _volume){
	switch(_volume){
		case   0: Volume =0.00;	break;
		case  25: Volume =0.05;	break;
		case  50: Volume =0.10;	break;
		case  75: Volume =0.15;	break;
		case 100: Volume =0.20;	break;

		////    float gain = 0.3; // 音量 float gain = 0.05; // 音量
